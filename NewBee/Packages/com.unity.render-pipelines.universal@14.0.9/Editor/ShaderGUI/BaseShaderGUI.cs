...
namespace UnityEditor
{
    ...
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            /// The text and tooltip for the receive shadows GUI.
            /// </summary>
            public static readonly GUIContent shLightText = EditorGUIUtility.TrTextContent("球谐多光源",
                "When enabled, other GameObjects can cast shadows onto this GameObject.");
        ...
        protected MaterialProperty shLightProp { get; set; }
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            shLightProp = FindProperty(Property.SHLights, properties, false);
        ...
        public virtual void DrawSurfaceOptions(Material material)
        {
            ...
            DrawFloatToggleProperty(Styles.shLightText, shLightProp);
        }
        ...
        {
            if (material.HasProperty("_SHLighting") && material.GetFloat("_SHLighting") > 0)
            {
                CoreUtils.SetKeyword(material, "_SH_LIGHTINGS_ON", true);
            }
            else
            {
                CoreUtils.SetKeyword(material, "_SH_LIGHTINGS_ON", false);
            }
